            ...
            <ul class="dropdown-menu dropdown-menu-end">
                <li>
                    <a class="dropdown-item {{ app()->getLocale() === 'en' ? 'active' : '' }}"
                        href="{{ route('lang.swap', ['locale' => 'en']) }}" data-language="en" data-text-direction="ltr">
                        <span>{{ __('English') }}</span>
                    </a>
                </li>
                <li>
                    <a class="dropdown-item {{ app()->getLocale() === 'fr' ? 'active' : '' }}"
                        href="{{ route('lang.swap', ['locale' => 'fr']) }}" data-language="fr" data-text-direction="ltr">
                        <span>{{ __('French') }}</span>
                    </a>
                </li>
            </ul>
                ...
                <div class="dropdown-menu dropdown-menu-end p-0">
                    ...
                    <div class="dropdown-shortcuts-list scrollable-container">
                        <div class="row row-bordered overflow-visible g-0">
                            ...
                            <div class="dropdown-shortcuts-item col">
                                <span class="dropdown-shortcuts-icon rounded-circle mb-3">
                                    <i class="icon-base ti tabler-users-group icon-26px text-heading"></i>
                                </span>
                                <a href="{{ route('members.index') }}" class="stretched-link">@lang('Members')</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <li class="border-top">
                    <div class="d-grid p-4">
                        <a class="btn btn-primary btn-sm d-flex" href="javascript:void(0);">
                            <small class="align-middle">{{ __('Mark all as read') }}</small>
                        </a>
                    </div>
                </li>
            </ul>
                ...
                @if (Auth::check())
                    <li>
                        <a class="dropdown-item bg-danger text-white" href="{{ route('logout') }}"
                            ...
                            <i class="icon-base ti tabler-login ms-2 icon-20px"></i>
                            <span>{{ __('Logout') }}</span>
                        </a>
                    </li>
